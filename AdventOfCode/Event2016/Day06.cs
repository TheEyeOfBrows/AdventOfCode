...
namespace AdventOfCode.Event2016
{
    class Day06
    {
        ...
        public string Run()
        {
           ...
           string result = string.Join("", columns.Select(column =>
                                                column.GroupBy(letter => letter)
